...
export const createSubSection = async ({formData, token}) => {
  let result = null
  // console.log("create sub section data in api", formData)
...
export const updateSection = async (data, token) => {
  let result = null
  console.log("here we are in the update section api")
  console.log("update sub section data in api", data, "otken",token)
  const toastId = toast.loading("Loading...")
  try {
...
export const fetchInstructorCourses = async (token) => {
  let result = []
  console.log("token from fetch api", token)
  const toastId = toast.loading("Loading...")
  try {
